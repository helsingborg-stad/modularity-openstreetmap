...
class CacheBust
{
    ...
    public function name($name)
    {
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITYOPENSTREETMAP_PATH . ' and run gulp. See ' . MODULARITYOPENSTREETMAP_PATH . 'README.md for more info.</div>';
        }
